...
Yes, it went from Pre-Alpha to Alpha in a day, because i worked hard on it. (another reason why is because i had already started the project on netlify, i reached my free credits, so then i used neocities, the website randomly got deleted, i tried again, and it got deleted again. So now im using Github Pages as frontend and supabase (free plan) for backend.)
